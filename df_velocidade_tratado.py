...
df_velocidade = pd.read_csv(r'C:\Users\Ferruccio\OneDrive\Área de Trabalho\Conhecimento\FACULDADE\MBA USP\TCC\Dados\dados_velocidade.csv', sep = ';', encoding = 'cp1252')
...
df_velocidade['velocidade'] = df_velocidade['velocidade'].apply(funcoes.calcular_mediana)
