...
data_path = current_dir.parent / 'data' / 'processed' / 'df_final.csv'
...
#%%
## Grafico de barra
for coluna in df_final.drop(columns={'Unnamed: 0','data','sentido_crescente','uf','velocidade_Comercial','velocidade_Moto',
...
#%%
## Grafico de Rosca 
for coluna in df_final.drop(columns={'Unnamed: 0','km','municipio','data','velocidade_Comercial','velocidade_Moto',
    ...
    with sns.axes_style("whitegrid"):
        ...
        plt.xticks()
        plt.yticks()
        plt.savefig(f'ad_rosca_{coluna}.png', dpi=600, transparent=True)
        plt.show()  
...
with sns.axes_style("whitegrid"):
        ...
        plt.savefig('ad_linha_mes.png', dpi=600, transparent=True)
        plt.show() 

#%%
## Graficos de BoxPlot Volume x Acidente
# Definindo as colunas que serão plotadas
colunas = df_final.drop(columns={'Unnamed: 0','km','municipio','data','sentido_crescente','uf','acidentes','chuva',
...
# Definindo as colunas que serão plotadas
colunas = df_final.drop(columns={'Unnamed: 0','km','municipio','data','sentido_crescente','uf','acidentes','acidentes',
                                 'dia_da_semana','mes','tipo_faixa','tipo_perfil_de_terreno','iluminacao',
